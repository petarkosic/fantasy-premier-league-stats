		...
		<div>
			{isModalOpen && (
				<div className={styles.playerModal}>
					<div className={styles.playerModalSummary}>
						<div className={styles.modalBanner}>
							...
							<div>
								...
								<div className={styles.modalPlayerName}>
						...
						<div className={styles.playerModalInfo}>
							<ul>
								<li>
									<h3>Price</h3>
									<div>{formatCurrency(topElement?.[0].now_cost)}m</div>
								...
								<li>
									...
									<div className={styles.rankTitle}>
										<strong>{topElement?.[0].ict_index_rank_type}</strong> of{' '}
										{elementType?.element_count}
									</div>
								</li>
								<li>
					...
					<div className={styles.chartHeatmap}>
						<div className={styles.playerModalChart}>{children}</div>

						<div className={styles.heatmapWrapper}>
							{isHeatmapError && (
								<div className={styles.heatmapError}>
							...
							<div className={styles.heatmapContainer}>
								...
								<div>
									...
									<div className={styles.playerModalHeatmap}>
